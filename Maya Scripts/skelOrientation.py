...
volition = Skeleton_Orientation(primary_axis=Axis.Xpos, torso_forward=Axis.Ypos, elbow_forward=Axis.Zneg, knee_forward=Axis.Ypos, right_side_reversed=True)
...
class Skeleton_Orientation:
	...
	def __init__(primary_axis=Axis.Xpos, torso_forward=Axis.Ypos, elbow_forward=Axis.Zneg, knee_forward=Axis.Ypos, right_side_reversed=True):
